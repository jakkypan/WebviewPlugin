...
/**
 * Tencent. Author: raez Date: 13-4-9 Time: 下午2:44
 *
...
public class PropertyUtils {
    ...
    static {
        try {
            ...
            sMethodGetString = sClassSystemProperties
    ...
    /**
     * Get property of corresponding key quickly (but provide less validity than {@link #get(String,
     * String)}).
     *
     * @param key property key.
     * @param defValue default value.
