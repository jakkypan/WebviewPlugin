...
public class PlatformUtil {
    ...
    public static final class VersionCodes {
         ...
         * support XLARGE screens will be assumed to do so only if they target {@link #HONEYCOMB} or
         * later; it had been {@link #GINGERBREAD} or later.  Applications that don't support a
         * screen size at least as large as the current screen will provide the user with a UI to
         * switch them in to screen size compatibility mode.</p>
         *
         * <p>This version introduces new screen size resource qualifiers
         * based on the screen size in dp: see {@link android.content.res.Configuration#screenWidthDp},
         * {@link android.content.res.Configuration#screenHeightDp}, and {@link
         * android.content.res.Configuration#smallestScreenWidthDp}. Supplying these in
         * &lt;supports-screens&gt; as per {@link android.content.pm.ApplicationInfo#requiresSmallestWidthDp},
         * {@link android.content.pm.ApplicationInfo#compatibleWidthLimitDp}, and {@link
         * android.content.pm.ApplicationInfo#largestWidthLimitDp} is preferred over the older
         * screen size buckets and for older devices the appropriate buckets will be inferred from
         * them.</p>
         *
         * <p>Applications targeting this or a later release will get these
         * new changes in behavior:</p>
